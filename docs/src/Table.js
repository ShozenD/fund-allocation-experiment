...
main_table = function( myAlloc ) {
  ...
  //<thead> element
  var thead = '<thead class="thead-dark"> <tr> <th scope="col">Non-profit Organization</th> <th scope="col">About</th> <th scope="col">Original Amount</th> <th scope="col">New Amount</th> </tr> </thead>';
